...
public class Constants {
    ...
    public static final double DRIVETRAIN_MAX_RPM = 571.3;

    public static final double DRIVETRAIN_MOTION_PROFILE_P = 0.025;
    ...
    public static final double DRIVETRAIN_MAX_VELOCITY = 6; //6 feet per second
